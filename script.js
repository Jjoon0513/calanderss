...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchEventsForSchool(schoolCode, year, month) {
      ...
      const url = `https://open.neis.go.kr/hub/SchoolSchedule?KEY=${loadConfig()}&Type=xml&ATPT_OFCDC_SC_CODE=S10&SD_SCHUL_CODE=${schoolCode}&AA_FROM_YMD=${startDate}&AA_TO_YMD=${endDate}`;
